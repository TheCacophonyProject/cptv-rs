...
* @returns {Uint8Array}
*/
module.exports.createTestCptvFile = function(params) {
    var ret = wasm.createTestCptvFile(addHeapObject(params));
...
const path = require('path').join(__dirname, 'encoder-node_bg.wasm');
